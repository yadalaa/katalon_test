...
WebUI.click(findTestObject('Object Repository/Page_Home page/img'))

WebUI.click(findTestObject('Object Repository/Page_Shipping/h2_SecretCharacter RESTAURANT CHECKOUT'))

WebUI.verifyElementText(findTestObject('Page_Shipping/h2_SecretCharacter RESTAURANT CHECKOUT'), title)

WebUI.click(findTestObject('Object Repository/Page_Shipping/div_YOUR ORDER REVIEW                Go Bac_e12cc4'))
